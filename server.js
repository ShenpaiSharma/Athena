...
app.get("/morse_code", function(req, res){
  res.render("morse_code", {post: post});
});

app.post("/morse_code", function(req, res){
  
  const title = req.body.postTitle;

  let decoded = decodeMorse(title);
  post = decoded;

  res.redirect('/morse_code')
});
...
// serverless-- 
// AccessKeyID: AKIAXKNSHYQGYUJ57HD5
// secretAccessKey: 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
